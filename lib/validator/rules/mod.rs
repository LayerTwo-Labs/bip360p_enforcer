...
mod tests {
    ...
    fn shutdown_residual_honesty_docs_inventory_lock() {
        ...
        // NOTE: this test previously also locked a `RESIDUAL.md` living in the
        // repo's *parent* directory via `include_str!("../../../../RESIDUAL.md")`.
        // That file was never committed, so the check could not compile from a
        // clean checkout; the in-repo MULTI_ENFORCER.md anchors above remain.
    }
}
